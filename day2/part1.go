...
func score(opponent, me string) int {
	...
	if opponent == "rock" && me == "rock" {
		sc = outcomeScoreMap["draw"]
	} else if opponent == "rock" && me == "scissors" {
		sc = outcomeScoreMap["lose"]
	} else if opponent == "rock" && me == "paper" {
		sc = outcomeScoreMap["win"]
	} else if opponent == "scissors" && me == "rock" {
		sc = outcomeScoreMap["win"]
	} else if opponent == "scissors" && me == "scissors" {
		sc = outcomeScoreMap["draw"]
		...
		sc = outcomeScoreMap["win"]
	} else if opponent == "paper" && me == "paper" {
		sc = outcomeScoreMap["draw"]
	} else {
		panic("invalid input" + opponent + " " + me)
	}
	return sc + scoreMap[me]
}
